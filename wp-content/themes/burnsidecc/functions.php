...
if (function_exists('register_sidebar'))
{
    ...
    register_sidebar(array(
        ...
        'description' => __('Widgets placed here will appear in the main sidebar', 'html5blank'),
        'id' => 'widget-area-1',
...
// Create 30 Word Callback for Custom Post Excerpts, call using html5wp_excerpt('html5wp_custom_post');
...
add_action('init', 'footer_scripts'); // Add Footer Scripts
add_action('init', 'register_main_menu'); // Add HTML5 Blank Menu
...
function recent_post() {
    ob_start();
    get_template_part('includes/most_recent_post');
    return ob_get_clean();
} 
add_shortcode( 'recent_post', 'recent_post' );

/***************************************************************
 * GET SCHEDULE FOR HOMEPAGE
 ***************************************************************/
function get_schedule() {
    ob_start();
    get_template_part('includes/get_schedule');
    return ob_get_clean();
} 
